...
cfg_auto_encoder = {
    ...
    "decoder": {
        "lstm":{
            "n_dim_lstm_hidden":n_dim_lstm_decoder_hidden,
            "n_dim_lstm_input":n_dim_latent*n_head
        },
        "latent":{
            ...
            #"simple_attention":{
            #   "n_dim_query":n_dim_lstm_hidden*4,
            ...
            "multi_head_attention":{
                "n_head":n_head,
                "n_dim_query":n_dim_lstm_decoder_hidden*2,
                "n_dim_memory":n_dim_latent,
                "n_dim_out":n_dim_latent*n_head,
                "dropout":0.0,
    ...
    "predictor": {
        "n_dim_in":n_dim_lstm_decoder_hidden
    },
    "sampler": {
        "n_sample":n_sample,
        "param_tau":log_linear_decay_generator(init_value=1.0, final_value=0.05, coef=-2E-7, offset=0),
    ...
    "loss": {
        "reg": {
            ...
            # }
            "kullback_leibler": {
                "scale":sigmoid_generator(scale=n_sample, coef=5E-7, offset=1E+7, min_value=n_sample/100.0),
                # "scale": n_sample/10.0,
                "weight_function_for_sequence_length":None,
...
cfg_corpus = {
    "train":{
        "corpus":os.path.join(dataset_dir, "language_modeling/wikitext-103/train_sentence_wordpiece.txt"),
        # "size":3793282,
        # "min_seq_len":None,
        # "max_seq_len":100
        "size":3750143,
    ...
    "test":{
        "corpus":os.path.join(dataset_dir, "language_modeling/wikitext-103/test_sentence_wordpiece.txt"),
        "min_seq_len":None,
        "max_seq_len":None,
        "evaluation_metrics":{"kldiv_ana":1, "kldiv_mc":1}
    },
    "dictionary":os.path.join(dataset_dir, "language_modeling/wikitext-103/vocab_wordpiece.dic"),
